      ...
      <main className="flex-grow bg-gray-50 py-8">
        <div className="container mx-auto px-4">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Démonstration de QualioFlex</h1>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Gérez facilement votre certification qualité avec QualioFlex</p>
                    </div>
                  </div>
