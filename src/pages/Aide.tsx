...
const faqs = [
  ...
  { q: "Quand auront lieu les prochaines fonctionnalités ?", r: "La roadmap inclut : module de notation des formateurs, pré-audit Qualiopi, intégration Stripe pour la facturation. Les mises à jour sont déployées automatiquement." },
];
